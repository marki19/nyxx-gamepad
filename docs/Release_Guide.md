...
`server/bin/Release/net8.0-windows/win-x64/publish/NyxxServer.exe`
...
3. Drag and drop both `NyxxServer.exe` and `app-debug.apk` into the "Attach binaries" box.
